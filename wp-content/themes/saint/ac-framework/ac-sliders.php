...
// Returns whether the Rev Slider is installed
function ac_revslider_is_installed() {
...
// Returns a compact array of Rev Slider data
...
// Imports all Rev Sliders from a folder
// Likely for a theme demo data import
function ac_import_rev_sliders( $rev_directory ) {
  ...
  global $wpdb;
	...
	if( class_exists('UniteFunctionsRev') ) { 
			...
			// Iterate the files in the import folder
