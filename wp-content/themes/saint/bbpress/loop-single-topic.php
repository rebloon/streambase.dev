...
<li class="list-group-item">
	...
	<ul id="bbp-topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
		<li class="bbp-topic-title col-sm-8 col-md-6">
		...
		<li class="bbp-topic-voice-count col-sm-1 col-md-2 text-center"><?php bbp_topic_voice_count(); ?></li>

		<li class="bbp-topic-reply-count col-sm-1 col-md-2 text-center"><?php bbp_show_lead_topic() ? bbp_topic_reply_count() : bbp_topic_post_count(); ?></li>

		<li class="bbp-topic-freshness col-sm-2 col-md-2 text-right small">
